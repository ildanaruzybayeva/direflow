...
import SampleComponent from './direflow-components/sample-component';

SampleComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('sample-component is mounted on the DOM', element);
});
